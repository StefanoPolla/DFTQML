...
x_train, y_train = utils.augment_data(densities, energies)

# Train the model with 5-fold cross validation
model = xgb.initialize_xgb()
cv_model = xgb.fit_xgb(model, x_train, y_train, optimize_hyperparameters=True, set_shuffle=True, verbose=1)
